...
#SBATCH --job-name=model6    # The job name.
...
R CMD BATCH --no-save --vanilla model6.R /burg/home/yt2661/projects/multinom-inf/experiments/model6/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt