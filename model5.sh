...
#SBATCH --job-name=model5    # The job name.
...
R CMD BATCH --no-save --vanilla model5.R /burg/home/yt2661/projects/multinom-inf/experiments/model5/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt