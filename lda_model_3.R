...
filename <- paste("/moto/home/yt2661/work/multinom-inf/experiments/lda_model_3/result/", seed, ".RData", sep = "")
...
for (i in 1:length(n)) {
  ...
  fit_debiased <- debiased_lasso(x = x, y = y, beta = beta, ncores = ncores,
