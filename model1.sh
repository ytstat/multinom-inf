...
#SBATCH --job-name=model1    # The job name.
...
R CMD BATCH --no-save --vanilla model1.R /burg/home/yt2661/projects/multinom-inf/experiments/model1/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt