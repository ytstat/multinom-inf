...
#SBATCH --job-name=model8    # The job name.
...
R CMD BATCH --no-save --vanilla model8.R /burg/home/yt2661/projects/multinom-inf/experiments/model8/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt