...
filename <- paste("/burg/home/yt2661/projects/multinom-inf/experiments/model8/result/", seed, ".RData", sep = "")
...
beta_coef[ind1+1, 1] <- rep(1, s)
beta_coef[ind2+1, 2] <- rep(1, s)
beta_coef[ind3+1, 3] <- rep(1, s)
