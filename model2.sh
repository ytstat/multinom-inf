...
#SBATCH --job-name=model2    # The job name.
...
R CMD BATCH --no-save --vanilla model2.R /burg/home/yt2661/projects/multinom-inf/experiments/model2/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt