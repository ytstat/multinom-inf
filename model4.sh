...
#SBATCH --job-name=model4    # The job name.
...
R CMD BATCH --no-save --vanilla model4.R /burg/home/yt2661/projects/multinom-inf/experiments/model4/out/${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.txt